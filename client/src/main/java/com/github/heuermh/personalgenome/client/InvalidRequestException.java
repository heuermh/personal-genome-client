 ...
 */
public final class InvalidRequestException extends PersonalGenomeClientException {

    /**
     * Create a new invalid request exception with the specified error description.
     *

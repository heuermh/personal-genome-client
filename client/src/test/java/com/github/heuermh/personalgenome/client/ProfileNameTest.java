...
/**
 * Unit test for ProfileName.
 */
public final class ProfileNameTest {

    @Test(expected=NullPointerException.class)
    public void testConstructorNullId() {
        new ProfileName(null, "First", "Last");
    }

    @Test(expected=NullPointerException.class)
    public void testConstructorNullFirstName() {
        new ProfileName("id", null, "Last");
    }

    @Test(expected=NullPointerException.class)
    public void testConstructorNullLastName() {
        new ProfileName("id", "First", null);
    }

    @Test
    public void testConstructor() {
        ProfileName profileName = new ProfileName("id", "First", "Last");
        assertNotNull(profileName);
        assertEquals("id", profileName.getId());
        assertEquals("First", profileName.getFirstName());
        assertEquals("Last", profileName.getLastName());
    }
}